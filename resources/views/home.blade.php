...
{{--                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Our high board consists of ambitious and creative people who makes all of this possible</p>--}}
            ...
            <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 lg:w-1/3 md:w-1/2 w-full" data-aos="fade-in" data-aos-delay="600">
                    <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                        <img alt="team" class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4 border" src="{{asset('img/highboard/Board of Directors/Maha Sharif - CCO.jpg')}}">
                        <div class="flex-grow">
                ...
                <form class="flex flex-wrap -m-2" method="POST" action="{{route('message.send')}}" data-aos="fade-up">
                    ...
                    <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                        ...
                        <span class="inline-flex">
                            <a class="text-gray-500" href="https://www.facebook.com/CurriculumVitaeSchools/">
                              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                              </svg>
                            </a>
                            <a class="ml-4 text-gray-500" href="https://t.me/CVS_team">
                              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                              </svg>
                            </a>
                            <a class="ml-4 text-gray-500" href="https://instagram.com/cvs_team1?igshid=1quaqeca5frzj">
                              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                                <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                              </svg>
                            </a>
                            <a class="ml-4 text-gray-500" href="https://youtube.com/channel/UCEnBXTDb3QXQ7XuMAOQM2Ag">
                              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
